...
private:
    ...
    // For populating and updating user's invalid character substitution preferences
    IRenameInvalidCharSub &     m_ricsInvalidCharSub;
...
private:
    // Sets the start directory lables appropriately for the operating system
    void SetStartDirectoryLabels();
...
private slots:
    ...
    // Restores default tag separator characters
    void RestoreDefaultTagSeparators();
