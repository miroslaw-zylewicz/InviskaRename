...
public:
    // Overriden if translations are available to populate language list
    virtual void PopulateLanguageList(QComboBox* pqcboLanguages);
    ...
    QString GetWebsite();
    QString GetInstructionsAddress();
