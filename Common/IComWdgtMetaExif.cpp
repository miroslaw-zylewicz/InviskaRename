...
void IComWdgtMetaExif::PopulateTable(IComMetaExif & rmexExifMeta)
{
    ...
    PopulateTableAddDivision(tr("GPS", "As in Global Positioning System.  Should probably remain as GPS"));
    PopulateTableAddItem(rmexExifMeta,  EXIF_IFD_GPS,    static_cast<ExifTag>(EXIF_TAG_GPS_LATITUDE));
    PopulateTableAddItem(rmexExifMeta,  EXIF_IFD_GPS,    static_cast<ExifTag>(EXIF_TAG_GPS_LATITUDE_REF));
    PopulateTableAddItem(rmexExifMeta,  EXIF_IFD_GPS,    static_cast<ExifTag>(EXIF_TAG_GPS_LONGITUDE));
    PopulateTableAddItem(rmexExifMeta,  EXIF_IFD_GPS,    static_cast<ExifTag>(EXIF_TAG_GPS_LONGITUDE_REF));
    PopulateTableAddItem(rmexExifMeta,  EXIF_IFD_GPS,    static_cast<ExifTag>(EXIF_TAG_GPS_ALTITUDE));
    PopulateTableAddItem(rmexExifMeta,  EXIF_IFD_GPS,    static_cast<ExifTag>(EXIF_TAG_GPS_ALTITUDE_REF));
    PopulateTableAddItem(rmexExifMeta,  EXIF_IFD_GPS,    static_cast<ExifTag>(EXIF_TAG_GPS_DATE_STAMP));
    PopulateTableAddItem(rmexExifMeta,  EXIF_IFD_GPS,    static_cast<ExifTag>(EXIF_TAG_GPS_TIME_STAMP));
}
