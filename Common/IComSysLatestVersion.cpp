...
void IComSysLatestVersion::DisplayVersionUpdate()
{
    ...
    if (qvnLatest > qvnCurrent && qvnLatest > qvnStoredLatest)
    {
        ...
        QString qsrTitle= tr("New Version Available");
        QString qstrCurrentVersion = tr("Current version:");
        QString qstrLatestVersion = tr("Latest version:");
        QString qstrDownload = tr("You can download the new version from:");
        QString qstrChanges = tr("A list of changes can be seen in the <a href='%1'>changelog</a>.").arg(m_pmwMainWindow->GetChangelogAddress());
        QString qstrMessage = QString("<center><p><h1>%1</h1></p>"
                                      "<p>%2 %3<br>%4 %5</p>"
                                      "</p>%6</p>"
                                      "<p><a href='%7'>%7</a></p>"
                                      "<p>%8</p></center>")
