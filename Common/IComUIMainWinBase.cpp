...
void IComUIMainWinBase::PopulateLanguageList(QComboBox* pqcboLanguages)
{
    pqcboLanguages->addItem("English", "");
}
...
QString IComUIMainWinBase::GetInstructionsAddress()
{
    return GetWebsite() + "/instructions";
}
